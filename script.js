document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function showFieldError(field, message) {
      ...
      field.setAttribute('aria-describedby', errorEl.id || (errorEl.id = 'error-' + Math.random().toString(36).substr(2, 9)));
    }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .then(function (response) {
          if (response.ok) {
            successMessage.textContent = contactForm.dataset.successMessage || 'Thank you! Your message has been sent successfully.';
        ...
        .catch(function () {
          const errorBanner = contactForm.querySelector('.form-error-banner') || (function () {
            const el = document.createElement('div');
          ...
          errorBanner.textContent = contactForm.dataset.errorMessage || 'Something went wrong. Please try again later.';
  ...
  const OBSERVED_SELECTOR = '[data-animate], .animate-on-scroll, .fade-in-section';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ד.י פרויקטים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b2df779b-8fbb-4441-81bd-f17a0f35f862',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b2df779b-8fbb-4441-81bd-f17a0f35f862';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b2df779b-8fbb-4441-81bd-f17a0f35f862';
